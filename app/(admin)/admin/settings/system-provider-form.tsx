...
import { CheckCircle, Plus, Trash2, Star, Zap, Info } from "lucide-react";
...
export function SystemProviderForm({ providers }: { providers: Provider[] }) {
  ...
  function handleSave() {
    startTransition(async () => {
      ...
      // reset
      setName(""); setSesAccessKeyId(""); setSesSecretAccessKey("");
      setSmtpHost(""); setSmtpUser(""); setSmtpPass(""); setResendApiKey("");
    });
  }
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          <strong>{p.name}</strong> will be removed. Any campaigns using this provider will fail to send.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
              ...
              <div className="space-y-4">
                <Alert>
                  <AlertDescription className="text-xs">
                    Create an IAM user with <strong>AmazonSESFullAccess</strong> and paste its credentials.
              ...
              <div className="space-y-4">
                <div className="grid gap-4 sm:grid-cols-3">
                  <div className="space-y-2 sm:col-span-2">
                    ...
                    <Input placeholder="smtp.yourdomain.com" value={smtpHost} onChange={(e) => setSmtpHost(e.target.value)} />
                  </div>
                  <div className="space-y-2">
                    <Label>Port</Label>
