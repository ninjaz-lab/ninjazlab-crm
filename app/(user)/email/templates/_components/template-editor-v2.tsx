...
export function TemplateEditorV2({templateId, defaultValues}: Props) {
    ...
    function handleCancel() {
        if (isDirty)
            ...
            router.push("/campaigns/email?tab=templates");
    }
            ...
            startTransition(async () => {
                try {
                    ...
                    if (templateId) {
                        ...
                        router.push(`/campaigns/email/templates/${id}`);
                    }
                } catch (err) {
            ...
            <div className="flex flex-col h-full border rounded-xl overflow-hidden bg-background shadow-sm">
                ...
                <div className="flex flex-col gap-3 p-5 border-b shrink-0 bg-muted/10">
                    <div className="flex items-center gap-2 pb-2">
                        ...
                        <h2 className="font-bold text-lg">Playground</h2>
                    </div>
            ...
            <AlertDialog open={showCancelDialog} onOpenChange={setShowCancelDialog}>
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            onClick={() => router.push("/campaigns/email?tab=templates")}
