    ...
    return (
        <Sidebar collapsible="icon" className="border-r">
                        ...
                        <SidebarMenuButton size="lg" asChild className="hover:bg-transparent transition-none">
                            <Link href={Routes.HOME}>
                                ...
                                <div
                                    ...
                                    <span
                                        className="truncate font-bold tracking-tighter text-lg uppercase">Ninjazlab</span>
                                    <span
                                        ...
                                        <Link href={item.href}>
                                            <HugeIcon
                                                ...
                                                className={cn(
                                                    ...
                                                    "opacity-70 group-hover:scale-110 group-hover:text-rose-600 group-hover:opacity-100",
            ...
            <SidebarFooter className="mt-auto pb-4">
                <NavUser variant={USER_ROLES.ADMIN}/>
            </SidebarFooter>
