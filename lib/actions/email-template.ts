...
// V2
export async function createEmailTemplateV2(data: {
    name: string;
    subject: string;
    previewText?: string;
    htmlBody: string;
...
export async function updateEmailTemplateV2(
    id: string,
    data: {
        name?: string;
        subject?: string;
...
export async function cloneEmailTemplateV2(templateId: string) {
    ...
    await db.insert(emailTemplateDetail).values({
        ...
        previewText: existing.email_template_detail.previewText,
        htmlBody: existing.email_template_detail.htmlBody,
        jsonBody: existing.email_template_detail.jsonBody,
        createdAt: new Date(),
        updatedAt: new Date(),
    });
